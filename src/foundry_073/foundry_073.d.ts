...
declare class Token extends PlaceableObject {
     ...
     */
    updateSource({ defer, deleted, noUpdateFog }?: boolean): void;
    /**
     ...
     */
    setPosition(x: number, y: number, { animate }?: boolean): Promise<any>;
    /**
     ...
     */
    setTarget(targeted?: boolean, { user, releaseOthers, groupSelection }?: User | null): void;
    /**
...
declare class User extends Entity {
     ...
     */
    assignHotbarMacro(macro: Macro | null, slot: number, { fromSlot }?: number): Promise<any>;
    /**
     * Get an Array of Macro Entities on this User's Hotbar by page
     * @param {number} page     The hotbar page number
     * @return {Array.<Object>}
     */
    getHotbarMacros(page?: number): Array<any>;
...
declare class PlaceableObject {
     ...
     */
    _updateRotation({ angle, delta, snap }?: number): number;
    /**
...
declare class PointSource {
     ...
     */
    initialize({ x, y, dim, bright, angle, rotation, color, alpha, animation, darknessThreshold, type }?: number): PointSource;
    x: any;
    y: any;
    angle: any;
    rotation: any;
     ...
     */
    animateTorch(dt: number, { speed, intensity }?: number): void;
    _flickerTime: number;
    /**
     ...
     * @param {number} intensity  The animation intensity, from 1 to 10
     */
    animatePulse(dt: number, { speed, intensity }?: number): void;
    _pulseAngle: any;
    /**
...
declare class Combat extends Entity {
     ...
     */
    rollInitiative(ids: string | string[], { formula, updateTurn, messageOptions }?: string | null): Promise<Combat>;
    /**
...
declare class Collection extends Map<any, any> {
     ...
     */
    find(condition: Function): any | null;
    /**
...
declare class Scene extends Entity {
     ...
     */
    createThumbnail({ img, width, height }?: string): object;
}
/**
...
declare class FormApplication extends Application {
     ...
     */
    submit(options: any | null): FormApplication;
    /**
...
declare class PlaceablesLayer extends CanvasLayer {
     ...
     */
    rotateMany({ angle, delta, snap, ids }?: number): Promise<any>;
    /**
     ...
     * @return {Promise}          The resulting Promise from the Scene.update operation
     */
    moveMany({ dx, dy, rotate, ids }?: number): Promise<any>;
    /**
     ...
     */
    pasteObjects(position: Point, { hidden, snap }?: boolean): Promise<PlaceableObject[]>;
    /**
     ...
     */
    selectObjects({ x, y, width, height, releaseOptions, controlOptions }?: number): boolean;
    /**
...
declare class Compendium extends Application {
     ...
     * @return {Promise<*>}
     */
    importAll({ folderId, folderName }?: string | null): Promise<any>;
    /**
...
declare class Application {
     ...
     */
    setPosition({ left, top, width, height, scale }?: number | null): {
        left: number;
        top: number;
        width: number;
        height: number;
